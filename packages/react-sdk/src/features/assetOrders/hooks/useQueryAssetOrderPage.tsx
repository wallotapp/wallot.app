...
import {
	UseQueryAssetOrderPageQueryKeyFn,
	UseQueryAssetOrderPageOptionsFn,
	UseQueryAssetOrderPageProps,
} from '@wallot/react/src/features/assetOrders/types/AssetOrderReactTypes';

export const getQueryAssetOrderPageReactQueryKey: UseQueryAssetOrderPageQueryKeyFn =
	(params) =>
		[
			'asset_order',
...
export const getQueryAssetOrderPageReactQueryOptions: UseQueryAssetOrderPageOptionsFn =
	(props) => ({
