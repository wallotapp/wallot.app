...
export const useConnectBankAccountsMutation = (options?: UseMutationOptions<ConnectBankAccountsResponse, GeneralizedError, ConnectBankAccountsParams<FinancialConnectionsSession.Account>>) => {
	const { user: firebaseUser } = useContext(AuthContext);
	return useMutation<ConnectBankAccountsResponse, GeneralizedError, ConnectBankAccountsParams<FinancialConnectionsSession.Account>>(
		(params: ConnectBankAccountsParams<FinancialConnectionsSession.Account>) => connectBankAccounts(firebaseUser, params),
		{
