...
export type UseCreateAssetMutationOptions =
	GeneralizedUseCreateDocumentsMutationOptions<Asset, CreateAssetParams>;
export type CreateAssetMutationData = Asset[];
export type CreateAssetMutationError = GeneralizedError;
export type CreateAssetMutationParams =
	FirestoreDocumentCreateParams<CreateAssetParams>;

export type UseUpdateAssetMutationOptions =
	GeneralizedUseUpdateDocumentsMutationOptions<UpdateAssetParams>;
export type UpdateAssetMutationData = unknown;
export type UpdateAssetMutationError = GeneralizedError;
export type UpdateAssetMutationParams =
	FirestoreDocumentUpdateParams<UpdateAssetParams>;
