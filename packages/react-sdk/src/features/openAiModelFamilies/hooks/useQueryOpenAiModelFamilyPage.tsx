...
import {
	UseQueryOpenAiModelFamilyPageQueryKeyFn,
	UseQueryOpenAiModelFamilyPageOptionsFn,
	UseQueryOpenAiModelFamilyPageProps,
} from '@wallot/react/src/features/openAiModelFamilies/types/OpenAiModelFamilyReactTypes';

export const getQueryOpenAiModelFamilyPageReactQueryKey: UseQueryOpenAiModelFamilyPageQueryKeyFn =
	(params) =>
		[
...
export const getQueryOpenAiModelFamilyPageReactQueryOptions: UseQueryOpenAiModelFamilyPageOptionsFn =
	(props) => ({
		queryFn: () => queryOpenAiModelFamilyPage(props.firestoreQueryOptions),
		queryKey: getQueryOpenAiModelFamilyPageReactQueryKey(
