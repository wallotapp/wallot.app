...
export type LicensePageQueryResponse = GeneralizedFirestoreCollectionPage<License>;
...
export type UseQueryLicensePageObserver = GeneralizedUseQueryPageObserver<License>;

export type UseCreateLicenseMutationOptions = GeneralizedUseCreateDocumentsMutationOptions<License, CreateLicenseParams>;
export type CreateLicenseMutationData = License[];
export type CreateLicenseMutationError = GeneralizedError;
export type CreateLicenseMutationParams = FirestoreDocumentCreateParams<CreateLicenseParams>;

export type UseUpdateLicenseMutationOptions = GeneralizedUseUpdateDocumentsMutationOptions<UpdateLicenseParams>;
export type UpdateLicenseMutationData = unknown;
export type UpdateLicenseMutationError = GeneralizedError;
export type UpdateLicenseMutationParams = FirestoreDocumentUpdateParams<UpdateLicenseParams>;
