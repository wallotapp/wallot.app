...
import { Position, CreatePositionParams, UpdatePositionParams } from '@wallot/js';

export type PositionPageQueryResponse = GeneralizedFirestoreCollectionPage<Position>;
...
export type UseQueryPositionPageObserver = GeneralizedUseQueryPageObserver<Position>;

export type UseCreatePositionMutationOptions = GeneralizedUseCreateDocumentsMutationOptions<Position, CreatePositionParams>;
export type CreatePositionMutationData = Position[];
export type CreatePositionMutationError = GeneralizedError;
export type CreatePositionMutationParams = FirestoreDocumentCreateParams<CreatePositionParams>;

export type UseUpdatePositionMutationOptions = GeneralizedUseUpdateDocumentsMutationOptions<UpdatePositionParams>;
export type UpdatePositionMutationData = unknown;
export type UpdatePositionMutationError = GeneralizedError;
export type UpdatePositionMutationParams = FirestoreDocumentUpdateParams<UpdatePositionParams>;
