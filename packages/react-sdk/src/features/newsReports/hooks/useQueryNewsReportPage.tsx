...
import {
	UseQueryNewsReportPageQueryKeyFn,
	UseQueryNewsReportPageOptionsFn,
	UseQueryNewsReportPageProps,
} from '@wallot/react/src/features/newsReports/types/NewsReportReactTypes';

export const getQueryNewsReportPageReactQueryKey: UseQueryNewsReportPageQueryKeyFn =
	(params) =>
		[
			'news_report',
...
export const getQueryNewsReportPageReactQueryOptions: UseQueryNewsReportPageOptionsFn =
	(props) => ({
