...
import { Team, CreateTeamParams, UpdateTeamParams } from '@wallot/js';

export type TeamPageQueryResponse = GeneralizedFirestoreCollectionPage<Team>;
...
export type UseQueryTeamPageObserver = GeneralizedUseQueryPageObserver<Team>;

export type UseCreateTeamMutationOptions =
	GeneralizedUseCreateDocumentsMutationOptions<Team, CreateTeamParams>;
...
export type UseUpdateTeamMutationOptions =
	GeneralizedUseUpdateDocumentsMutationOptions<Team, UpdateTeamParams>;
