...
import {
	UseQueryAssetPricePageQueryKeyFn,
	UseQueryAssetPricePageOptionsFn,
	UseQueryAssetPricePageProps,
} from '@wallot/react/src/features/assetPrices/types/AssetPriceReactTypes';

export const getQueryAssetPricePageReactQueryKey: UseQueryAssetPricePageQueryKeyFn =
	(params) =>
		[
			'asset_price',
...
export const getQueryAssetPricePageReactQueryOptions: UseQueryAssetPricePageOptionsFn =
	(props) => ({
