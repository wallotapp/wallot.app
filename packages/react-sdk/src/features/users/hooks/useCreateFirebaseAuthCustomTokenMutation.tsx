...
export const useCreateFirebaseAuthCustomTokenMutation = (options?: UseMutationOptions<FirebaseUserCustomTokenResponse, GeneralizedError, Record<string, never>>) => {
	const { user: firebaseUser } = useContext(AuthContext);
	return useMutation<FirebaseUserCustomTokenResponse, GeneralizedError, Record<string, never>>((params: Record<string, never>) => createFirebaseAuthCustomToken(firebaseUser, params), {
