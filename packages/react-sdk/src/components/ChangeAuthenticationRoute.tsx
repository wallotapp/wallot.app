...
export const ChangeAuthenticationRoute: React.FC<ChangeAuthenticationRouteProps> = ({ oppositeRoute, text }) => {
	return (
		<div className='flex flex-col items-center justify-center w-fit py-16 px-8 mx-auto'>
			<div>
				<Link href={oppositeRoute}>
					<div className={cn('flex items-center space-x-0.5 cursor-pointer', 'text-base')}>
