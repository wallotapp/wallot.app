...
import { useUpdateScholarshipApplicationMutation } from '@wallot/react/src/features/scholarshipApplications';
...
const updateOperationMutationMap = {
	...
	scholarship_application: useUpdateScholarshipApplicationMutation,
