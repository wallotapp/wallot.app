...
export type FundingAccountCategory =
	keyof typeof FundingAccountCategoryEnum.obj;
...
export type FundingAccount = yup.InferType<
	typeof fundingAccountsApi.apiResourceJsonSchema
>;
