...
export const alphaVantageCompanyProperties = {
	alpha_vantage_company_200DayMovingAverage: yup.string().nullable().default(null),
	alpha_vantage_company_50DayMovingAverage: yup.string().nullable().default(null),
	...
	alpha_vantage_company_AnalystRatingHold: yup.string().nullable().default(null),
	alpha_vantage_company_AnalystRatingSell: yup.string().nullable().default(null),
	alpha_vantage_company_AnalystRatingStrongBuy: yup.string().nullable().default(null),
	alpha_vantage_company_AnalystRatingStrongSell: yup.string().nullable().default(null),
	alpha_vantage_company_AnalystTargetPrice: yup.string().nullable().default(null),
	...
	alpha_vantage_company_MarketCapitalization: yup.string().nullable().default(null),
	...
	alpha_vantage_company_OperatingMarginTTM: yup.string().nullable().default(null),
	...
	alpha_vantage_company_PriceToSalesRatioTTM: yup.string().nullable().default(null),
	alpha_vantage_company_ProfitMargin: yup.string().nullable().default(null),
	alpha_vantage_company_QuarterlyEarningsGrowthYOY: yup.string().nullable().default(null),
	alpha_vantage_company_QuarterlyRevenueGrowthYOY: yup.string().nullable().default(null),
	alpha_vantage_company_ReturnOnAssetsTTM: yup.string().nullable().default(null),
	alpha_vantage_company_ReturnOnEquityTTM: yup.string().nullable().default(null),
	alpha_vantage_company_RevenuePerShareTTM: yup.string().nullable().default(null),
	...
	alpha_vantage_company_SharesOutstanding: yup.string().nullable().default(null),
	alpha_vantage_company_Symbol: yup.string().defined().meta({ unique_key: true }),
	alpha_vantage_company_TrailingPE: yup.string().nullable().default(null),
} as const;

export const AlphaVantageCompanyPropertyNameEnum = getEnum(Keys(alphaVantageCompanyProperties));
export type AlphaVantageCompanyPropertyName = keyof typeof AlphaVantageCompanyPropertyNameEnum.obj;

export type RemoveAlphaVantageCompanyPrefix<T> = {
	[K in keyof T as K extends `alpha_vantage_company_${infer Rest}` ? Rest : K]: T[K];
};
