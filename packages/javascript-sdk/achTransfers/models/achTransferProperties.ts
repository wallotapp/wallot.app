...
import { AlpacaAchTransferPropertyNameEnum, alpacaAchTransferProperties, RemoveAlpacaAchTransferPrefix, AlpacaAchTransferPropertyName } from '../utils/alpacaAchTransfers.js';
...
const createParamsRequiredFieldEnum = getEnum([...GeneralizedApiResourceCreateParamsRequiredFieldEnum.arr, ...AlpacaAchTransferPropertyNameEnum.arr, 'bank_account'] as const);
...
export type AchTransfer = yup.InferType<typeof achTransfersApi.apiResourceJsonSchema>;
...
export type AlpacaAchTransfer = RemoveAlpacaAchTransferPrefix<Pick<AchTransfer, AlpacaAchTransferPropertyName>>;
