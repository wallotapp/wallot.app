...
export type AlpacaAchTransferDirection =
	keyof typeof AlpacaAchTransferDirectionEnum.obj;
...
export type AlpacaAchTransferStatus =
	keyof typeof AlpacaAchTransferStatusEnum.obj;
...
export type AlpacaAchTransferWireFeePaymentMethod =
...
export const alpacaAchTransferProperties = {
	...
	alpaca_ach_transfer_additional_information: yup
		.string()
		.nullable()
		.default(null),
	...
	alpaca_ach_transfer_fee_payment_method:
		AlpacaAchTransferWireFeePaymentMethodEnum.getOptionalSchema()
			.nullable()
			.default(null),
	alpaca_ach_transfer_requested_amount: yup.string().nullable().default(null), // "1234.56" for $1,234.56 (Must be > 0.00)
};

export const AlpacaAchTransferPropertyNameEnum = getEnum(
	Keys(alpacaAchTransferProperties),
);
export type AlpacaAchTransferPropertyName =
	keyof typeof AlpacaAchTransferPropertyNameEnum.obj;

export type RemoveAlpacaAchTransferPrefix<T> = {
	[K in keyof T as K extends `alpaca_ach_transfer_${infer Rest}`
		? Rest
		: K]: T[K];
};
