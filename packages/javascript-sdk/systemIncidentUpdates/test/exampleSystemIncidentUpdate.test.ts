import { SystemIncidentUpdate, systemIncidentUpdatesApi } from '../models/index.js';
...
describe('SystemIncidentUpdate', () => {
  test('exampleSystemIncidentUpdate', () => {
    ...
    expect(exampleSystemIncidentUpdate).toEqual<typeof exampleSystemIncidentUpdate>({
