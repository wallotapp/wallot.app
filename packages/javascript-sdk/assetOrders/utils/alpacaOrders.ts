...
// Asset Class
export const AlpacaOrderAssetClassEnum = getEnum([
	'us_equity',
	'us_option',
	'crypto',
]);
...
// Order Class
export const AlpacaOrderOrderClassEnum = getEnum([
	'simple',
	'bracket',
	'oco',
	'oto',
...
// Order Type
export const AlpacaOrderOrderTypeEnum = getEnum([
	'market',
	'limit',
	'stop',
	'stop_limit',
...
// Side
export const AlpacaOrderSideEnum = getEnum([
	'buy',
	'sell',
	'buy_minus',
	'sell_plus',
...
// Time in Force
export const AlpacaOrderTimeInForceEnum = getEnum([
	'day',
	'gtc',
	'opg',
	'cls',
...
export type AlpacaOrderTimeInForce =
	keyof typeof AlpacaOrderTimeInForceEnum.obj;

// Type
export const AlpacaOrderTypeEnum = getEnum([
	'market',
	'limit',
	'stop',
	'stop_limit',
...
export const alpacaOrderProperties = {
	alpaca_order_asset_class: AlpacaOrderAssetClassEnum.getOptionalSchema()
		.nullable()
		.default(null),
	...
	alpaca_order_order_class: AlpacaOrderOrderClassEnum.getOptionalSchema()
		.nullable()
		.default(null),
	alpaca_order_order_type: AlpacaOrderOrderTypeEnum.getOptionalSchema()
		.nullable()
		.default(null),
	...
	alpaca_order_time_in_force: AlpacaOrderTimeInForceEnum.getOptionalSchema()
		.nullable()
		.default(null),
	alpaca_order_type: AlpacaOrderTypeEnum.getOptionalSchema()
		.nullable()
		.default(null),
...
export type AlpacaOrderPropertyName =
	keyof typeof AlpacaOrderPropertyNameEnum.obj;
