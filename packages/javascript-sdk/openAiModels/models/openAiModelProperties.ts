...
const createParamsRequiredFieldEnum = getEnum([...GeneralizedApiResourceCreateParamsRequiredFieldEnum.arr, 'date_published', 'open_ai_model_family'] as const);
...
const properties = {
	...
	open_ai_model_family: apiYupHelpers.idRef(['open_ai_model_family']).min(1).meta({ unique_key: false }),
} as const;
...
export type OpenAiModel = yup.InferType<typeof openAiModelsApi.apiResourceJsonSchema>;
