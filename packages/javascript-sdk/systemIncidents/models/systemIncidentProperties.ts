...
export type SystemIncidentCategory =
	keyof typeof SystemIncidentCategoryEnum.obj;
...
export type SystemIncident = yup.InferType<
	typeof systemIncidentsApi.apiResourceJsonSchema
>;
