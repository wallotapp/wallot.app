...
export type SecretData = GeneralizedSecretData & {
  ...
  SECRET_CRED_ALPACA_API_KEY: string;
  SECRET_CRED_ALPACA_API_SECRET: string;
  SECRET_CRED_OPENAI_API_KEY: string;
  SECRET_CRED_STRIPE_API_KEY: string;
  SECRET_CRED_STRIPE_PREMIUM_LICENSE_PRODUCT_ID: string;
  SECRET_CRED_STRIPE_PREMIUM_LICENSE_PRODUCT_MONTHLY_PRICE_ID: string;
};
