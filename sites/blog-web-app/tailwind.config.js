...
module.exports = {
	content: ['./pages/**/*.{js,ts,jsx,tsx}', './src/**/*.{js,ts,jsx,tsx}', '../../packages/javascript-sdk/**/*.{js,ts}', '../../packages/react-sdk/**/*.{js,ts,jsx,tsx}', '../../node_modules/ergonomic-react/**/*.{js,ts,jsx,tsx}'],
	darkMode: 'class',
	mode: 'jit',
	safelist,
	theme: {
